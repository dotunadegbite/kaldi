...
steps/online/prepare_online_decoding.sh --cmd "$train_cmd" ~/kaldi/egs/mycorpus/data/train ~/kaldi/egs/mycorpus/data/lang \
    ~/kaldi/egs/mycorpus/exp/tri4a ~/kaldi/egs/mycorpus/exp/tri4a/final.mdl exp/tri4a_online/ || exit 1;
...
steps/online/decode.sh --do-endpointing true \
  --config conf/decode.config --cmd "$decode_cmd" --nj 20 ~/kaldi/egs/mycorpus/exp/tri4a/graph \
  ~/kaldi/egs/mycorpus/data/test ~/kaldi/egs/mycorpus/exp/tri4a_online/decode_endpointing
